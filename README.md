...
야금야금(Poco)은 해야 할 일을 시작하지 못해 멈춰 있는 사용자를 돕는 AI 실행 보조 애플리케이션 프로토타입입니다. 사용자가 할 일을 두서없이 적거나 과제 사진, 수업 자료를 올리면 AI가 과업을 작고 명확한 행동 단계로 나누고, 지금 바로 시작할 수 있는 순서로 정리해주는 것을 목표로 합니다.
...
## 핵심 기능
<img width="1920" height="4416" alt="main" src="https://github.com/user-attachments/assets/9e865f60-9b10-444b-beb9-7854fca0a769" />
...
- **Design Resources**: Assets.xcassets, PNG 기반 앱 로고 및 타이틀 이미지
...
수익 모델은 프리미엄 프로모션으로 진입 장벽을 낮추고, 실행 이력 저장과 개인화 AI 기능을 제공하는 프리미엄 모델로 전환을 유도하는 방향을 고려하고 있습니다.
